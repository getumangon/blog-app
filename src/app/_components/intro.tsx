...
export function Intro() {
  ...
  const styles = {
    ...
    glassCard: {
      ...
      backdropFilter: darkMode ? "blur(2px)" : "blur(12px)",
      WebkitBackdropFilter: "blur(02px)",
      border: darkMode
  ...
  return (
    <section className="">
      ...
      <Head>
        ...
        <meta property="og:description" content="I try to build cool things." />
      ...
      >
        ...
        >
          ...
          <div style={styles.socialLinks as CSSProperties}>
            ...
            >
              <svg
                style={styles.socialIcon as CSSProperties}
                viewBox="0 0 24 24"
                fill="currentColor"
              >
          ...
          <p style={styles.description as CSSProperties}>
            "From Browser Tabs to App Stores." Building the next generation of
            web and mobile apps with React Native and AI.
          </p>
          ...
          <div style={styles.navLinks as CSSProperties}>
            ...
            >
              blog
              <svg
                style={styles.linkIcon as CSSProperties}
                viewBox="0 0 24 24"
                fill="none"
