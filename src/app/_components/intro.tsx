    ...
    <section className="">
      ...
      <main style={{
        ...
        style={{
          ...
          <Logo />
          <h1 style={styles.title}>Umang Patel</h1>
          <p style={styles.subtitle}>Problem Solver & Occasional Bug Creator</p>
          ...
          <div style={styles.navLinks}>
            ...
            <svg  style={styles.linkIcon} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="Interface / External_Link"> <path id="Vector" 
